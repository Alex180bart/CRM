...
const nextConfig = {
   ...
   * symlink; com a raiz padrão (a pasta do app), o rastreamento segue os links
   * para fora do escopo e **não copia** o que está do lado de lá. Vale para
   * qualquer plataforma que empacote a função a partir dessa análise — e o
   * sintoma é o pior tipo: o build passa, o deploy conclui, e a função morre na
   * primeira requisição com `Cannot find module`, apontando uma dependência que
   * existe na máquina de quem compilou.
   */
